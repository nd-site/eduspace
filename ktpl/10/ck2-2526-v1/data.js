...
window.quizData = {
    ...
    questions: [
        // ── HỆ THỐNG CHÍNH TRỊ VN ──────────────────────────────────────────
        {
            ...
            options: [
                "Đảng Cộng sản Việt Nam, Nhà nước CHXHCN Việt Nam, Mặt trận Tổ quốc Việt Nam và các tổ chức chính trị - xã hội",
                "Quốc hội, Chính phủ, Toà án nhân dân và Viện kiểm sát nhân dân",
                "Nhà nước CHXHCN Việt Nam và các tổ chức tôn giáo",
                "Đảng Cộng sản Việt Nam và các doanh nghiệp nhà nước"
            ],
            correct: 0,
            explanation: "Hệ thống chính trị bao gồm 3 bộ phận cấu thành: Đảng (lãnh đạo), Nhà nước (quản lí), Mặt trận và các tổ chức CT-XH (làm chủ)."
        },
        {
            type: "multiple",
        ...
        // ── PHÁP LUẬT CHUNG ────────────────────────────────────────────────
        {
            ...
            options: [
                "Là những quy tắc xử sự do một tổ chức tự đặt ra",
                "Là hệ thống các quy tắc xử sự mang tính bắt buộc chung, do Nhà nước ban hành hoặc thừa nhận và bảo đảm thực hiện",
                "Là những chuẩn mực đạo đức được lưu truyền trong dân gian",
                "Là những thoả thuận giữa các công dân trong xã hội"
            ],
            correct: 1,
            explanation: "Pháp luật do Nhà nước ban hành, thể hiện ý chí của giai cấp thống trị và có tính bắt buộc chung."
        },
        {
            type: "multiple",
        ...
        {
            type: "multiple",
            question: "Đặc trưng nào làm nên sự khác biệt cốt lõi giữa pháp luật và đạo đức?",
            options: [
                "Tính quy phạm",
                "Tính quyền lực, bắt buộc chung (được đảm bảo bằng cưỡng chế của Nhà nước)",
                "Tính hướng thiện",
                "Tính lịch sử"
            ],
            correct: 1,
            explanation: "Chỉ pháp luật mới có sức mạnh cưỡng chế của quyền lực nhà nước (phạt tiền, phạt tù...)."
        },
        {
            type: "multiple",
        ...
        // ── TỰ LUẬN ──────────────────────────────────────────────────────
        {
            ...
            suggested: "1. Sự khác biệt:\n- Mục đích:\n  + Khiếu nại: Khôi phục quyền và lợi ích hợp pháp của BẢN THÂN người khiếu nại bị xâm phạm.\n  + Tố cáo: Ngăn chặn và xử lí hành vi vi phạm pháp luật, bảo vệ lợi ích của NHÀ NƯỚC, TỔ CHỨC hoặc CÁ NHÂN KHÁC.\n- Đối tượng:\n  + Khiếu nại: Là các Quyết định hành chính hoặc Hành vi hành chính (thường của người có thẩm quyền).\n  + Tố cáo: Là Hành vi vi phạm pháp luật của BẤT CỨ CƠ QUAN, TỔ CHỨC, CÁ NHÂN NÀO.\n\n2. Ví dụ:\n- Khiếu nại: Anh A bị Chủ tịch UBND xã ra quyết định thu hồi đất sai diện tích, anh A làm đơn khiếu nại quyết định đó.\n- Tố cáo: Chị B phát hiện một xưởng sản xuất đang lén lút xả hóa chất độc hại ra sông, chị B làm đơn tố cáo gửi cơ quan công an môi trường.",
            points: 25,
            explanation: "AI chấm: Phân biệt được mục đích (bản thân vs lợi ích chung) (10đ); Phân biệt đối tượng (quyết định hành chính vs hành vi phạm pháp luật) (5đ); Cho ví dụ đúng cho khiếu nại và tố cáo (10đ)."
        },
        {
            type: "essay",
            question: "Hãy phân tích tính quyền lực, bắt buộc chung (tính cưỡng chế) của pháp luật. Tính chất này có mâu thuẫn với tính dân chủ của pháp luật hay không? Vì sao?",
            suggested: "1. Phân tích: Tính quyền lực, bắt buộc chung nghĩa là pháp luật do Nhà nước ban hành, được đảm bảo thực hiện bằng sức mạnh của Nhà nước. Mọi tổ chức, cá nhân đều phải tuyệt đối tuân theo, nếu vi phạm sẽ bị áp dụng các biện pháp chế tài, cưỡng chế (phạt tiền, phạt tù...).\n2. Không mâu thuẫn với tính dân chủ: \n- Vì pháp luật ở nước ta thể hiện ý chí của giai cấp công nhân và nhân dân lao động (do Quốc hội - đại diện cho dân ban hành).\n- Việc cưỡng chế, bắt buộc tuân thủ pháp luật chính là để bảo vệ quyền lợi hợp pháp, chính đáng của số đông nhân dân, duy trì trật tự xã hội an toàn, kỉ cương. Xử lí nghiêm kẻ phạm tội chính là để bảo vệ nền dân chủ thực sự.",
            points: 25,
            explanation: "AI chấm: Giải thích đúng tính quyền lực bắt buộc chung (đảm bảo bằng cưỡng chế) (10đ). Lập luận được việc không mâu thuẫn, do pháp luật đại diện ý chí nhân dân và cưỡng chế để bảo vệ quyền lợi hợp pháp của người dân (15đ)."
        },
        {
            type: "essay",
            question: "Hiện nay, trên mạng xã hội xuất hiện nhiều tài khoản đăng tải thông tin sai sự thật, xuyên tạc các chính sách của Nhà nước. Khi được nhắc nhở, họ biện minh rằng mình đang thực hiện 'quyền tự do ngôn luận'. \nDựa vào kiến thức về Hiến pháp và pháp luật, em hãy phản bác lại quan điểm sai trái trên.",
            suggested: "Quan điểm trên là hoàn toàn sai trái.\n- Hiến pháp 2013 quy định công dân có quyền tự do ngôn luận, tự do báo chí. Tuy nhiên, quyền này phải được thực hiện trong khuôn khổ của pháp luật.\n- Việc lợi dụng quyền tự do ngôn luận để đăng tải thông tin sai sự thật, xuyên tạc, bôi nhọ cá nhân, tổ chức, chống phá Nhà nước là hành vi vi phạm pháp luật (vi phạm Luật An ninh mạng và các quy định hình sự/hành chính).\n- Quyền tự do của cá nhân không được xâm phạm đến lợi ích quốc gia, dân tộc, quyền và lợi ích hợp pháp của người khác. Nếu vi phạm sẽ bị xử lí nghiêm minh theo pháp luật.",
            points: 25,
            explanation: "AI chấm: Khẳng định quan điểm sai (5đ); Giải thích quyền tự do ngôn luận phải trong khuôn khổ pháp luật (10đ); Chỉ ra việc lợi dụng xâm phạm lợi ích quốc gia là phạm luật (10đ)."
        }
    ]
};
