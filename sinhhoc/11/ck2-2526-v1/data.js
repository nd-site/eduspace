...
window.quizData = {
    ...
    questions: [
        ...
        // ── TỰ LUẬN ──────────────────────────────────────────────────────
        {
            ...
            suggested: "- Cơ sở tế bào học:\n+ Sinh sản vô tính: Dựa trên quá trình nguyên phân.\n+ Sinh sản hữu tính: Dựa trên quá trình giảm phân (tạo giao tử) và thụ tinh.\n- Đặc điểm di truyền của thế hệ con:\n+ Sinh sản vô tính: Con sinh ra giống hệt nhau và giống cây mẹ (kém đa dạng).\n+ Sinh sản hữu tính: Con mang tổ hợp vật chất di truyền của bố và mẹ nên có tính đa dạng di truyền cao, thích nghi tốt với môi trường biến đổi.",
            points: 25,
            explanation: "AI chấm: So sánh đúng cơ sở tế bào (nguyên phân vs giảm phân+thụ tinh) và đặc điểm di truyền (giống nhau vs đa dạng)."
        },
        {
            type: "essay",
            question: "Thụ tinh kép ở thực vật Hạt kín là gì? Nêu ý nghĩa của thụ tinh kép.",
            suggested: "- Thụ tinh kép: Là hiện tượng xảy ra ở thực vật Hạt kín, trong đó cùng một lúc 2 giao tử đực (tinh tử) tham gia thụ tinh:\n+ 1 giao tử đực (n) kết hợp với trứng (n) tạo thành hợp tử (2n) phát triển thành phôi.\n+ 1 giao tử đực (n) kết hợp với nhân cực (2n) tạo thành tế bào nhân tam bội (3n) phát triển thành phôi nhũ.\n- Ý nghĩa: Phôi nhũ (3n) dự trữ chất dinh dưỡng dồi dào để nuôi phôi phát triển cho đến khi cây con tự dưỡng được, giúp hạt của thực vật Hạt kín thích nghi cao và có tỉ lệ nảy mầm tốt.",
            points: 25,
            explanation: "AI chấm: Nêu đúng 2 sự kết hợp trong thụ tinh kép và ý nghĩa cung cấp dinh dưỡng của phôi nhũ."
        },
        {
            type: "essay",
            question: "Giải thích tại sao cơ thể sinh vật được coi là một hệ thống mở và tự điều chỉnh?",
            suggested: "- Hệ thống mở: Cơ thể sinh vật luôn không ngừng trao đổi vật chất và năng lượng với môi trường xung quanh (lấy thức ăn, O2, thải chất bã, CO2...).\n- Hệ thống tự điều chỉnh: Cơ thể có các cơ chế để duy trì sự cân bằng động trong cơ thể (hằng tính nội môi) thông qua sự phối hợp hoạt động của các hệ cơ quan (nhờ hệ thần kinh và hệ nội tiết), giúp cơ thể thích nghi với sự thay đổi của môi trường.",
            points: 25,
            explanation: "AI chấm: Giải thích được 'mở' là do trao đổi vật chất/năng lượng với môi trường; 'tự điều chỉnh' là duy trì cân bằng nội môi nhờ thần kinh/nội tiết."
        }
    ]
};
