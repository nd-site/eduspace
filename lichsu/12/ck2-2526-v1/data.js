...
window.quizData = {
    ...
    questions: [
        // ── VIỆT NAM GIAI ĐOẠN 1954 - 1975 ───────────────────────────────
        {
            ...
            options: [
                "Đất nước hoàn toàn độc lập, đi lên chủ nghĩa xã hội",
                "Đất nước bị chia cắt làm hai miền với hai chế độ chính trị - xã hội khác nhau",
                "Cả nước nằm dưới sự thống trị của thực dân Pháp",
                "Miền Bắc tiếp tục kháng chiến chống Pháp, miền Nam được giải phóng"
            ],
            correct: 1,
            explanation: "Do Mĩ phá hoại Hiệp định, Việt Nam tạm thời bị chia cắt tại vĩ tuyến 17 thành hai miền với hai chế độ khác biệt."
        },
        {
            type: "multiple",
            question: "Nhiệm vụ chiến lược của cách mạng miền Bắc sau năm 1954 là gì?",
            options: [
                "Tiến hành cách mạng dân tộc dân chủ nhân dân",
                "Tiến hành cách mạng xã hội chủ nghĩa, làm hậu phương vững chắc cho miền Nam",
                "Chỉ tập trung chống Mĩ, bỏ qua phát triển kinh tế",
                "Chuẩn bị lực lượng tiến công quân sự sang Mĩ"
            ],
            correct: 1,
            explanation: "Miền Bắc tiến lên CNXH, xây dựng tiềm lực kinh tế và quốc phòng để chi viện cho tiền tuyến miền Nam."
        },
        {
            type: "multiple",
        ...
        {
            type: "multiple",
            question: "Chiến lược 'Chiến tranh đặc biệt' (1961-1965) của Mĩ ở miền Nam Việt Nam được thực hiện bằng lực lượng chủ yếu nào?",
            options: [
                "Quân đội viễn chinh Mĩ",
                "Quân đội các nước đồng minh của Mĩ",
                "Quân đội Sài Gòn dưới sự chỉ huy của cố vấn Mĩ",
                "Lính đánh thuê Nam Hàn"
            ],
            correct: 2,
            explanation: "Bản chất của Chiến tranh đặc biệt là 'Dùng người Việt đánh người Việt', dựa vào quân đội Sài Gòn và cố vấn Mĩ."
        },
        {
            type: "multiple",
        ...
        {
            type: "multiple",
            question: "Chiến lược 'Chiến tranh cục bộ' (1965-1968) có điểm gì khác biệt cơ bản so với 'Chiến tranh đặc biệt'?",
            options: [
                "Chỉ sử dụng vũ khí hiện đại",
                "Có sự tham gia trực tiếp và quy mô lớn của lực lượng quân đội viễn chinh Mĩ",
                "Chỉ diễn ra ở đồng bằng",
                "Không có cố vấn Mĩ"
            ],
            correct: 1,
            explanation: "Chiến tranh cục bộ được tiến hành bằng quân Mĩ (giữ vai trò chủ chốt), quân đồng minh Mĩ và quân đội Sài Gòn."
        },
        {
            type: "multiple",
            question: "Sự kiện nào đã buộc Mĩ phải tuyên bố 'phi Mĩ hóa' chiến tranh xâm lược (tức thừa nhận thất bại của Chiến tranh cục bộ)?",
            options: [
                "Chiến thắng Vạn Tường (1965)",
                "Chiến thắng Khe Sanh (1968)",
                "Cuộc Tổng tiến công và nổi dậy Xuân Mậu Thân 1968",
                "Trận Điện Biên Phủ trên không (1972)"
            ],
            correct: 2,
            explanation: "Tết Mậu Thân 1968 tạo ra bước ngoặt quyết định, làm lung lay ý chí xâm lược của Mĩ, buộc Mĩ phải ngồi vào bàn đàm phán Paris."
        },
        {
            type: "multiple",
            question: "Hiệp định Paris năm 1973 có ý nghĩa lớn nhất đối với cuộc kháng chiến chống Mĩ cứu nước là:",
            options: [
                "Chấm dứt hoàn toàn chiến tranh ở Việt Nam",
                "Đánh cho 'Mĩ cút', tạo thời cơ thuận lợi để đánh cho 'Ngụy nhào'",
                "Mĩ cam kết bồi thường chiến tranh cho Việt Nam",
                "Thống nhất đất nước ngay lập tức"
            ],
            correct: 1,
            explanation: "Theo Hiệp định Paris, Mĩ phải rút toàn bộ quân đội về nước ('Mĩ cút'), làm thay đổi so sánh lực lượng có lợi cho Cách mạng để tiến tới giải phóng hoàn toàn miền Nam ('Ngụy nhào')."
        },
        {
            type: "multiple",
            question: "Trận đánh nào được mệnh danh là 'Điện Biên Phủ trên không'?",
            options: [
                "Chiến dịch Linebacker II - Đánh trả cuộc tập kích chiến lược bằng B52 của Mĩ vào Hà Nội, Hải Phòng cuối năm 1972",
                "Trận đánh chặn máy bay Mĩ ở Hàm Rồng (Thanh Hóa)",
                "Chiến dịch phòng không năm 1965",
                "Chiến dịch Hồ Chí Minh 1975"
            ],
            correct: 0,
            explanation: "12 ngày đêm cuối năm 1972, quân dân miền Bắc bắn rơi nhiều máy bay B52, đập tan uy thế không lực Mĩ."
        },
        {
            type: "multiple",
        ...
        {
            type: "multiple",
            question: "Thời khắc lịch sử đánh dấu sự sụp đổ hoàn toàn của chính quyền Sài Gòn là:",
            options: [
                "11 giờ 30 phút ngày 30/4/1975",
                "10 giờ 45 phút ngày 30/4/1975",
                "0 giờ ngày 1/5/1975",
                "17 giờ ngày 2/5/1975"
            ],
            correct: 0,
        ...
        // ── TỰ LUẬN ──────────────────────────────────────────────────────
        {
            ...
            suggested: "1. Nguyên nhân (Bối cảnh):\n- Khách quan: Tác động của cuộc CM Khoa học kĩ thuật; Liên Xô và các nước XHCN Đông Âu lâm vào khủng hoảng toàn diện → Buộc VN phải đổi mới để hội nhập và phát triển.\n- Chủ quan: Đất nước lâm vào khủng hoảng kinh tế - xã hội trầm trọng (lạm phát phi mã, thiếu lương thực). Cơ chế tập trung quan liêu bao cấp không còn phù hợp, kìm hãm sản xuất. 'Đổi mới hay là chết' là mệnh lệnh của lịch sử.\n\n2. Nội dung đổi mới kinh tế (trọng tâm):\n- Xóa bỏ cơ chế quản lí kinh tế tập trung quan liêu, bao cấp.\n- Hình thành cơ chế thị trường có sự quản lí của Nhà nước theo định hướng xã hội chủ nghĩa.\n- Phát triển nền kinh tế hàng hóa nhiều thành phần (thừa nhận kinh tế tư nhân, vốn nước ngoài...).\n- Mở rộng quan hệ kinh tế đối ngoại.",
            points: 25,
            explanation: "AI chấm: Nêu được bối cảnh (chủ quan khủng hoảng, khách quan thế giới biến động) (10đ). Nêu đủ 3 nội dung kinh tế (bỏ bao cấp, nhiều thành phần, thị trường định hướng XHCN) (15đ)."
        },
        {
            type: "essay",
            question: "Phân tích ý nghĩa lịch sử của Đại thắng mùa Xuân năm 1975 đối với dân tộc Việt Nam và thế giới.",
            suggested: "1. Ý nghĩa với dân tộc:\n- Chấm dứt 21 năm kháng chiến chống Mĩ và 30 năm chiến tranh giải phóng dân tộc, bảo vệ Tổ quốc.\n- Chấm dứt vĩnh viễn ách thống trị của chủ nghĩa đế quốc và phong kiến ở nước ta.\n- Hoàn thành cuộc cách mạng dân tộc dân chủ nhân dân trên cả nước, thống nhất đất nước.\n- Mở ra kỉ nguyên mới: kỉ nguyên đất nước độc lập, thống nhất, đi lên CNXH.\n\n2. Ý nghĩa với thế giới:\n- Làm thất bại âm mưu ngăn chặn chủ nghĩa cộng sản của đế quốc Mĩ.\n- Cổ vũ mạnh mẽ phong trào giải phóng dân tộc trên thế giới, báo hiệu sự sụp đổ của chủ nghĩa thực dân mới.",
            points: 25,
            explanation: "AI chấm: Phân tích đầy đủ 4 ý nghĩa đối nội (chấm dứt chiến tranh, thống nhất, kỉ nguyên mới) (15đ) và 2 ý nghĩa đối ngoại (làm thất bại Mĩ, cổ vũ thế giới) (10đ)."
        },
        {
            type: "essay",
            question: "Từ những bài học lịch sử của cuộc kháng chiến chống Mĩ cứu nước (1954-1975), em hãy rút ra một bài học có thể áp dụng vào công cuộc xây dựng và bảo vệ Tổ quốc hiện nay.",
            suggested: "- Bài học tiêu biểu: Giương cao ngọn cờ độc lập dân tộc và chủ nghĩa xã hội, phát huy sức mạnh đại đoàn kết toàn dân tộc kết hợp với sức mạnh thời đại.\n- Áp dụng hiện nay:\n  + Trong xây dựng đất nước: Cần đoàn kết mọi tầng lớp nhân dân, mọi thành phần kinh tế, phát huy trí tuệ Việt Nam. Đồng thời tích cực hội nhập quốc tế, tranh thủ vốn, công nghệ (sức mạnh thời đại) để phát triển kinh tế.\n  + Trong bảo vệ Tổ quốc: Giữ vững độc lập tự chủ, kết hợp sức mạnh quân sự với sức mạnh ngoại giao, kinh tế; xây dựng thế trận quốc phòng toàn dân để bảo vệ vững chắc chủ quyền (đặc biệt là chủ quyền biển đảo).",
            points: 25,
            explanation: "AI chấm: Nêu đúng bài học (đại đoàn kết, kết hợp sức mạnh dân tộc và thời đại) (10đ). Liên hệ thực tiễn hiện nay hợp lí (hội nhập, phát triển kinh tế, bảo vệ chủ quyền) (15đ)."
        }
    ]
};
